...
export default function EconomicPage() {
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-xl font-bold text-white">Economic Intelligence</h1>
        <p className="text-sm text-slate-400 mt-1">
          Market signals — every entry carries its source, confidence, and methodology. Analysis, not certainty.
