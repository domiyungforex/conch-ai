    ...
    <div className="min-h-screen flex items-center justify-center px-4 bg-stone-50">
      <Card className="w-full max-w-md bg-white border-stone-200">
        <CardHeader className="text-center">
          <CardTitle className="text-2xl font-semibold text-stone-900">Join THE WAY</CardTitle>
          <CardDescription className="text-stone-500">Start your journey with Scripture</CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          ...
          <div className="relative">
            <Separator />
            <span className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-white px-2 text-xs text-stone-500">or sign up with email</span>
          </div>
